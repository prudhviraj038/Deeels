...
public class ReturnPolicyFragment extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        header.setText(Settings.getword(getActivity(),"delivery_return_policy"));
        des.setText(Html.fromHtml(Settings.getSettings(getActivity(), "return_policy"+Settings.get_lan(getActivity()))));
    }
}