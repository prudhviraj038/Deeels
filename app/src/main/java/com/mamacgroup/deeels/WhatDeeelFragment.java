 ...
 */
public class WhatDeeelFragment extends Fragment {
    TextView header,des;
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        header.setText(Settings.getword(getActivity(),"about_us"));
        des.setText(Html.fromHtml(Settings.getSettings(getActivity(), "about"+Settings.get_lan(getActivity()))));
    }
}